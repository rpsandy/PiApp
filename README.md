...
3. Click the file name to start downloading. It may take a moment depending on your internet speed.

4. Once the download finishes, open the file by double-clicking it. Windows may show a security alert; choose "Run" to continue.
...
6. After the installation finishes, you can select “Launch PiApp” to open it right away or use the desktop shortcut later.
...
3. Run the installer. It will update your current version without affecting your files.
